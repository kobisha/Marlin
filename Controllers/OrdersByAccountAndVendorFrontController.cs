...
namespace Marlin.sqlite.Controllers
{
    ...
    [ApiController]
    public class OrdersByAccountAndVendorFrontController : ControllerBase
    {
        private readonly DataContext _context;

        public OrdersByAccountAndVendorFrontController(DataContext context)
        {
            _context = context;
        }

        [HttpGet("{AccountID}/{VendorID}")]
